...
class ReleasePackagingTests(unittest.TestCase):
    def test_version_is_release_version(self):
        self.assertEqual(build_deb.read_version(ROOT), "0.7.3")
    ...
    def test_builds_deb_with_expected_control_and_payload(self):
        ...
        self.assertEqual(
            ...
            "enigma2-plugin-extensions-epgtoxml_0.7.3_all.deb",
        )
        ...
        self.assertIn("Version: 0.7.3", control)
    ...
    def test_builds_reproducible_ipk_for_vti(self):
        ...
        self.assertEqual(
            ...
            "enigma2-plugin-extensions-epgtoxml_0.7.3_all.ipk",
        )
